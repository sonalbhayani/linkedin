    ...
    return (
        ...
        <div className='bg-[#f3f2f0] w-full min-h-screen pb-5'>
            ...
            <div className="flex flex-col lg:flex-row justify-center items-start gap-5 m-5">
                <div className="lg:w-[25%] w-full min-h-[300px] bg-white rounded-lg relative">
                    <div className='bg-gray-400 w-full h-30 rounded-t-lg cursor-pointer'></div>
                    <FiCamera className='absolute top-3 right-3 w-8 h-8 text-white cursor-pointer' />
                    <div className='flex flex-col pl-10 absolute top-[80px]' >
                        <img src={profile} alt="profile" className='w-20 h-20 rounded-full cursor-pointer hover:text-gray-900' />
                    ...
                    <div className='top-[200px] absolute'>
                        <button className='w-[200px] h-[40px] text-lg font-bold 
